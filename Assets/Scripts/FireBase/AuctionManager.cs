...
public class AuctionManager : MonoBehaviour
{
    ...
    {
        {
            database = FirebaseDatabase.GetInstance(
                "https://photontestproject-8f5de-default-rtdb.asia-southeast1.firebasedatabase.app/"
            );
    ...
    void SellItem(string itemName)
    {
        ...
        DatabaseReference auctionRef = reference.Child("Auctions").Push();
    ...
    public void OnSellPotionButton()
    {
        SellItem("Potion");
    }
    public void OnSellPotionBomb()
    {
        SellItem("Bomb");
    }
    public void OnSellPotionTicket()
    {
        SellItem("Ticket");
    }
}
